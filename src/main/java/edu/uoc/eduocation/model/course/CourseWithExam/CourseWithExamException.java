...
public class CourseWithExamException extends Exception {
  public static final String INVALID_DATE = "[ERROR] Exam date can't be null or future";
  public static final String INVALID_TIME = "[ERROR] Exam time can't be null or future";
